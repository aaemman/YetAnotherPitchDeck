...
public class SlidingTabLayout extends FrameLayout {
    ...
    private void populateTabStrip() {
        ...
        TextView tabTitleTextView = null;
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tabView instanceof TextView) {
                tabTitleTextView = (TextView) tabView;
    ...
    private TextView getTitleTextViewAt(int position) {
        if (!mIsCustomTabSet) {
            return (TextView) tabStrip.getChildAt(position);
        } else {
            return null;
        }
    }
...
// ------ INNER CLASSES ------
    ...
    private class ViewBinder extends com.yapd.alexander.yapd.util.view.common.ViewBinder {
...
// ------ HELPER CLASSES ------
    ...
    public class SlidingTabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < tabStrip.getChildCount(); i++) {
                ...
                TextView tabTitleTextView = getTitleTextViewAt(i);
    ...
    public class DefaultTabAdapter extends TabAdapater {
        ...
        public void bindTabView(View tabView, int position) {
            final PagerAdapter adapter = viewPager.getAdapter();
            ((TextView) tabView).setText(adapter.getPageTitle(position));
        }
    }
}
